          ...
          <div class="row">
            <div class="col-md-12">
              <div class="title-area">
                ...
                <p>
                  PT. Bintang Andalan Teknologi adalah perusahaan/ kontraktor yang bergerak di bidang jasa instalasi Mekanikal dan Elektrikal di  Indonesia,menyediakan layanan untuk kebutuhan anda dengan beberapa beberapa yang telah kami sediakan di bawah ini.
                </p>
              </div>
            </div>
            <div class="col-md-12">
                   ...
                   <div class="panel panel-default">
                    <div class="panel-body">
                      <div class="single-service wow zoomIn">
                        <i class="fa fa-gear service-icon"></i>
                        <h4 class="service-title"><a href="#" data-target="#AIR-CONDITIONING" data-toggle="modal">ACMV</a></h4>
                ...
                <div class="col-lg-4">
                 <div class="panel panel-default" style="height: 100px;">
                  <div class="panel-body">
                    <div class="single-service wow zoomIn">
                      <i class="fa fa-gear service-icon"></i>
                      <h4 class="service-title"><a href="" data-target="#PLUMBING-SANITARY" data-toggle="modal">PLUMBING & SANITARY</a></h4>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-4">
               <div class="panel panel-default">
                <div class="panel-body">
                  <div class="single-service wow zoomIn">
                    <i class="fa fa-gear service-icon"></i>
                    <h4 class="service-title"><a href="" data-target="#ELECTRICAL" data-toggle="modal">ELECTRICAL</a></h4>
                  </div>
                </div>
              </div>
            </div>
