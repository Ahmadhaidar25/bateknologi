             ...
             <div class="row">
              ...
              <div class="col-md-8">
               <div class="contact-area-right">
                ...
                <div class="form-group">                        
                  <textarea placeholder="Comment" rows="3" name="comment" id="comment" class="form-control"></textarea>
                </div>
                <button type="button" class="comment-btn" id="send-email">Submit Comment</button>
